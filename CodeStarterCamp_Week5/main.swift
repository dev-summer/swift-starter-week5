...
var sooman = AuditionManager(name: "sooman")
sooman.cast(applicant: yagom)
sooman.cast(applicant: noroo)
sooman.cast(applicant: coda)
sooman.cast(applicant: odong)
sooman.announcePassedApplicants()
